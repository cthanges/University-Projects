...
//sc_start(0, SC_NS);
  // tracing:
	...
	if(j==1)cout << "Packets received: " <<  sink1.pkt_recv<< endl;			
	...
	if(j==7)cout << "Packets received: " <<  sink7.pkt_recv<< endl;			
	...
	if(j==9)cout << "Packets received: " <<  sink9.pkt_recv<< endl;
	if(i==10)cout << "Packets sent: " <<  source10.pkt_snt<< endl;
	if(j==10)cout << "Packets received: " <<  sink10.pkt_recv<< endl;
	...
	if(j==13)cout << "Packets received: " <<  sink13.pkt_recv<< endl;
